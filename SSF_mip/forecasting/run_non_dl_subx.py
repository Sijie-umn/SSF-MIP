...
def forecast_non_dl(month_id, year, rootpath, param_path, model_name, subx_model):
    ...
    # send model to gpu
    filename = rootpath + 'forecast_results/models/model_{}_{}_{}_{}.sav'.format(model_name, year, month_id, subx_model)
    ...
    save_results(rootpath + 'forecast_results/results_{}_{}_{}_{}.pkl'.format(model_name, year, month_id, subx_model), results)
