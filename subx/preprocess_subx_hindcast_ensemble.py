...
if model == 'NCEP':
    ...
    date = pd.date_range('1999-07-05', '2015-12-27')
    path = '/glade/work/bcash/ssf/subx/hindcast/tas2m/daily/full/GMAO-GEOS_V2p1/'
...
for e in range(1, 5):
    ...
    data.to_hdf('tmp2m_{}_hindcast_e{}.h5'.format(model, e), key='data')
