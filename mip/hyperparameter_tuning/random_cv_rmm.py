...
def random_cv(cv_index, cv_year, roothpath, param_grid, num_random, model_name, device, one_day):
    ...
    if model_name in ['CNN_LSTM', 'CNN_FNN']:
        ...
        train_y = load_results(rootpath + 'rmm/train_y_pca_{}_forecast{}.pkl'.format(cv_year, cv_index))
        valid_y = load_results(rootpath + 'rmm/val_y_pca_{}_forecast{}.pkl'.format(cv_year, cv_index))
    ...
    save_results(rootpath + 'cv_results_test/cv_results_' + model_name + '_{}_{}_rmm.pkl'.format(cv_year, cv_index), cv_results)
