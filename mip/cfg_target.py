...
path = '/glade/work/hexxx/SSF_mip/'  # need to change to the absolute path of the data files
path_save = '/glade/work/hexxx/SSF_mip/data/'   # need to change to the absolute path to save data_files
absolute_path = '/glade/work/hexxx/SSF_mip/'  # need to change to the absolute path of the code files
...
# preprocessing
rootpath_data = '/glade/work/hexxx/climate_data/cov/cov_mip/'
savepath_data = '/glade/work/hexxx/climate_data/cov/cov_mip/pca/'
vars = ['sst', 'sm', 'tmp2m', 'hgt10', 'hgt500', 'slp', 'rhum.sig995']
locations = ['pacific', 'us', 'us', 'global', 'global', 'global', 'global']

num_pcs = 10

# train-validation split
data_target_file = savepath_data + 'tmp2m_western_us_anom_zscore.h5'
...
param_grid_en_de = {'hidden_dim': [32, 64, 128, 256],
                    'num_layers': [1, 2, 3],
                    'learning_rate': [0.001],
                    'threshold': [0.5, 0.6],
