...
def main():
    ...
    target = None  # pd.read_hdf('/glade/work/hexxx/climate_data/cov/cov_mip/pca/tmp2m_western_us_anom_rmm.h5')
    ...
    test_time_index_all = pd.date_range(test_start_date, end_date)  # daily

    # to create train-validation sets

    # for year in val_years:
    #     if year == 2017:
    #         for num_forecast in range(1, 7):
    ...
    #             #                                      n_jobs=20)
    #     else:
    #         for num_forecast in range(1, 13):
    #             preprocess.train_val_split(cv_path,
    #                                        data,
    #                                        target, target_var,
    #                                        year, num_forecast,
    ...
    for year in test_years:
        if year == 2020:
            ...
            for num_forecast in range(7, 13):
                preprocess.train_test_split(forecast_path,
                                            data,
                                            target, target_var,
                                            test_time_index_all,
