...
def best_hyperparameter(val_years, month_range, eval_metrics, model_name, rootpath, subx_model):
...
for model_name in model_names:
    ...
    #     print(cmd)
    #     os.system(cmd)
    for subx in ['NCEP', 'NCEP_date']:  # ['GMAO', 'GMAO_date']
        print('find the best hyper parameter for {}'.format(model_name))
        best_hyperparameter(val_years=val_years, month_range=month_range, eval_metrics=metric, model_name=model_name, rootpath=rootpath, subx_model=subx)
